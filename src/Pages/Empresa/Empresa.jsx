    ...
    <div>
      ...
      <div className="containerEmpresa">
        ...
        <div className="containerCont">
          <p>
            <b>INMOBILIARIA ROSSI</b> es una empresa que fundamos en la ciudad
            de Las Piedras con larga experiencia dentro de la localidad y en sus
            alrededores, comenzamos por el año 1990 con la tercera generación
            Henry Edison <b>ROSSI PASINA</b> . Somos una empresa familiar que
            busca dar un trato directo, personalizado y profesional al cliente.
            ...
            acompañándolo en la toma de decisiones. Además tenemos profesionales
            que nos permiten un amplio asesoramiento notarial, jurídico y
            contable, para brindarle un servicio integral. Somos una empresa en
            el mercado inmobiliario, dedicada a la venta, alquiler y
